...
public class Plant extends ClockDomain{
  ...
  public void thread1480(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1487 = 0;
        if(ends[8]>=biggest1487){
          biggest1487=ends[8];
        }
        if(ends[9]>=biggest1487){
          biggest1487=ends[9];
        }
        if(ends[10]>=biggest1487){
          biggest1487=ends[10];
        }
        if(ends[11]>=biggest1487){
          biggest1487=ends[11];
        }
        if(ends[12]>=biggest1487){
          biggest1487=ends[12];
        }
        if(ends[13]>=biggest1487){
          biggest1487=ends[13];
        }
        if(biggest1487 == 1){
          active[7]=1;
  ...
  public void thread1466(int [] tdone, int [] ends){
    ...
    if(ends[9]>=biggest1473){
      biggest1473=ends[9];
    }
    if(ends[10]>=biggest1473){
      biggest1473=ends[10];
    }
    if(ends[11]>=biggest1473){
      biggest1473=ends[11];
    }
    if(ends[12]>=biggest1473){
      biggest1473=ends[12];
    }
    if(ends[13]>=biggest1473){
      biggest1473=ends[13];
    }
    if(biggest1473 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1459){
        ...
        case 2 : 
          ...
          int biggest1488 = 0;
          if(ends[2]>=biggest1488){
            biggest1488=ends[2];
          }
          if(ends[3]>=biggest1488){
            biggest1488=ends[3];
          }
          if(ends[4]>=biggest1488){
            biggest1488=ends[4];
          }
          if(ends[5]>=biggest1488){
            biggest1488=ends[5];
          }
          if(ends[6]>=biggest1488){
            biggest1488=ends[6];
          }
          if(ends[7]>=biggest1488){
            biggest1488=ends[7];
          }
          if(biggest1488 == 1){
            active[1]=1;
