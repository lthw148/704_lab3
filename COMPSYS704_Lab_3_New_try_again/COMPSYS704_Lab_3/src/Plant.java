...
public class Plant extends ClockDomain{
  ...
  public void thread1646(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1653 = 0;
        if(ends[8]>=biggest1653){
          biggest1653=ends[8];
        }
        if(ends[9]>=biggest1653){
          biggest1653=ends[9];
        }
        if(ends[10]>=biggest1653){
          biggest1653=ends[10];
        }
        if(ends[11]>=biggest1653){
          biggest1653=ends[11];
        }
        if(ends[12]>=biggest1653){
          biggest1653=ends[12];
        }
        if(ends[13]>=biggest1653){
          biggest1653=ends[13];
        }
        if(biggest1653 == 1){
          active[7]=1;
  ...
  public void thread1632(int [] tdone, int [] ends){
    ...
    int biggest1639 = 0;
    if(ends[8]>=biggest1639){
      biggest1639=ends[8];
    }
    if(ends[9]>=biggest1639){
      biggest1639=ends[9];
    }
    if(ends[10]>=biggest1639){
      biggest1639=ends[10];
    }
    if(ends[11]>=biggest1639){
      biggest1639=ends[11];
    }
    if(ends[12]>=biggest1639){
      biggest1639=ends[12];
    }
    if(ends[13]>=biggest1639){
      biggest1639=ends[13];
    }
    if(biggest1639 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1625){
        ...
        case 1 : 
          ...
          if(ends[5]>=biggest1640){
            biggest1640=ends[5];
          }
          if(ends[6]>=biggest1640){
            biggest1640=ends[6];
          }
          if(ends[7]>=biggest1640){
            biggest1640=ends[7];
          }
          if(biggest1640 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1654 = 0;
          if(ends[2]>=biggest1654){
            biggest1654=ends[2];
          }
          if(ends[3]>=biggest1654){
            biggest1654=ends[3];
          }
          if(ends[4]>=biggest1654){
            biggest1654=ends[4];
          }
          if(ends[5]>=biggest1654){
            biggest1654=ends[5];
          }
          if(ends[6]>=biggest1654){
            biggest1654=ends[6];
          }
          if(ends[7]>=biggest1654){
            biggest1654=ends[7];
          }
          if(biggest1654 == 1){
            active[1]=1;
