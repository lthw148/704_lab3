...
public class Plant extends ClockDomain{
  ...
  public void thread1655(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1662 = 0;
        if(ends[8]>=biggest1662){
          biggest1662=ends[8];
        }
        if(ends[9]>=biggest1662){
          biggest1662=ends[9];
        }
  ...
  public void thread1641(int [] tdone, int [] ends){
    ...
    int biggest1648 = 0;
    if(ends[8]>=biggest1648){
      biggest1648=ends[8];
    }
    if(ends[9]>=biggest1648){
      biggest1648=ends[9];
    }
    if(ends[10]>=biggest1648){
      biggest1648=ends[10];
    }
    if(ends[11]>=biggest1648){
      biggest1648=ends[11];
    }
    if(ends[12]>=biggest1648){
      biggest1648=ends[12];
    }
    if(ends[13]>=biggest1648){
      biggest1648=ends[13];
    }
    if(biggest1648 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1634){
        ...
        case 2 : 
          ...
          int biggest1663 = 0;
          if(ends[2]>=biggest1663){
            biggest1663=ends[2];
          }
          if(ends[3]>=biggest1663){
            biggest1663=ends[3];
          }
          if(ends[4]>=biggest1663){
            biggest1663=ends[4];
          }
          if(ends[5]>=biggest1663){
            biggest1663=ends[5];
          }
          if(ends[6]>=biggest1663){
            biggest1663=ends[6];
          }
          if(ends[7]>=biggest1663){
            biggest1663=ends[7];
          }
          if(biggest1663 == 1){
            active[1]=1;
