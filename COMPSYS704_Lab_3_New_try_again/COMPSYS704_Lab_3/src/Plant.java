...
public class Plant extends ClockDomain{
  ...
  public void thread1357(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1364 = 0;
        if(ends[8]>=biggest1364){
          biggest1364=ends[8];
        }
        if(ends[9]>=biggest1364){
          biggest1364=ends[9];
        }
        if(ends[10]>=biggest1364){
          biggest1364=ends[10];
        }
        if(ends[11]>=biggest1364){
          biggest1364=ends[11];
        }
        if(ends[12]>=biggest1364){
          biggest1364=ends[12];
        }
        if(ends[13]>=biggest1364){
          biggest1364=ends[13];
        }
        if(biggest1364 == 1){
          active[7]=1;
  ...
  public void thread1343(int [] tdone, int [] ends){
    ...
    int biggest1350 = 0;
    if(ends[8]>=biggest1350){
      biggest1350=ends[8];
    }
    if(ends[9]>=biggest1350){
      biggest1350=ends[9];
    }
    if(ends[10]>=biggest1350){
      biggest1350=ends[10];
    }
    if(ends[11]>=biggest1350){
      biggest1350=ends[11];
    }
    if(ends[12]>=biggest1350){
      biggest1350=ends[12];
    }
    if(ends[13]>=biggest1350){
      biggest1350=ends[13];
    }
    if(biggest1350 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1336){
        ...
        case 1 : 
          ...
          int biggest1351 = 0;
          if(ends[2]>=biggest1351){
            biggest1351=ends[2];
          }
          if(ends[3]>=biggest1351){
            biggest1351=ends[3];
          }
          if(ends[4]>=biggest1351){
            biggest1351=ends[4];
          }
        ...
        case 2 : 
          ...
          int biggest1365 = 0;
          if(ends[2]>=biggest1365){
            biggest1365=ends[2];
          }
          if(ends[3]>=biggest1365){
            biggest1365=ends[3];
          }
          if(ends[4]>=biggest1365){
            biggest1365=ends[4];
          }
          if(ends[5]>=biggest1365){
            biggest1365=ends[5];
          }
          if(ends[6]>=biggest1365){
            biggest1365=ends[6];
          }
          if(ends[7]>=biggest1365){
            biggest1365=ends[7];
          }
          if(biggest1365 == 1){
            active[1]=1;
