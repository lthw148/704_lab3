...
public class Plant extends ClockDomain{
  ...
  public void thread1350(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1357 = 0;
        if(ends[8]>=biggest1357){
          biggest1357=ends[8];
        }
        if(ends[9]>=biggest1357){
          biggest1357=ends[9];
        }
        if(ends[10]>=biggest1357){
          biggest1357=ends[10];
        }
        if(ends[11]>=biggest1357){
          biggest1357=ends[11];
        }
        if(ends[12]>=biggest1357){
          biggest1357=ends[12];
        }
        if(ends[13]>=biggest1357){
          biggest1357=ends[13];
        }
        if(biggest1357 == 1){
          active[7]=1;
  ...
  public void thread1336(int [] tdone, int [] ends){
    ...
    int biggest1343 = 0;
    if(ends[8]>=biggest1343){
      biggest1343=ends[8];
    }
    if(ends[9]>=biggest1343){
      biggest1343=ends[9];
    }
    if(ends[10]>=biggest1343){
      biggest1343=ends[10];
    }
    if(ends[11]>=biggest1343){
      biggest1343=ends[11];
    }
    if(ends[12]>=biggest1343){
      biggest1343=ends[12];
    }
    if(ends[13]>=biggest1343){
      biggest1343=ends[13];
    }
    if(biggest1343 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1329){
        ...
        case 1 : 
          ...
          int biggest1344 = 0;
          if(ends[2]>=biggest1344){
            biggest1344=ends[2];
          }
          if(ends[3]>=biggest1344){
            biggest1344=ends[3];
          }
          if(ends[4]>=biggest1344){
            biggest1344=ends[4];
          }
          if(ends[5]>=biggest1344){
            biggest1344=ends[5];
          }
          if(ends[6]>=biggest1344){
            biggest1344=ends[6];
          }
          if(ends[7]>=biggest1344){
            biggest1344=ends[7];
          }
          if(biggest1344 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1358 = 0;
          if(ends[2]>=biggest1358){
            biggest1358=ends[2];
          }
          if(ends[3]>=biggest1358){
            biggest1358=ends[3];
          }
          if(ends[4]>=biggest1358){
            biggest1358=ends[4];
          }
          if(ends[5]>=biggest1358){
            biggest1358=ends[5];
          }
          if(ends[6]>=biggest1358){
            biggest1358=ends[6];
          }
          if(ends[7]>=biggest1358){
            biggest1358=ends[7];
          }
          if(biggest1358 == 1){
            active[1]=1;
